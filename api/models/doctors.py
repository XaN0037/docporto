...
class Doctor(models.Model):
    ...
    # motto_uz = models.TextField('Shifokor shiori o\'zbek tilida')
    # motto_ru = models.TextField('Shifokor shiori rus tilida')
    # motto_en = models.TextField('Shifokor shiori ingliz tilida')
